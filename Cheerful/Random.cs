...
namespace Cheerful
{
    ...
    {
        public static readonly new Random Shared = new();
        ...
        {
            return Convert.ToUInt16(Shared.Next(-32768, 32767));
        }

        //public virtual ulong NextULong()
        //{
        //    return Convert.ToUInt64(Shared.Next(0, 18446744073709551615));
        //}

        //public virtual uint NextUInt()
        //{
        //    return Convert.ToUInt32(Shared.Next(0, 4294967295));
        //}
